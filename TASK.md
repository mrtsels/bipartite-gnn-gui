...
### C. 海报布置（2026-08-13 Thu 14:30–16:30）

| # | 条目 | 状态 | 备注 |
|---|------|------|------|
| C1 | 自行打印海报 | ⏳ | 08-13 前 |
| C2 | 13 日 14:30–16:30 到展板安装（现场提供别针） | ⏳ | 08-13 |
| C3 | 展板 74.5" 垂直 × 37" 水平，材料不得超出 | ✅ | 海报 46.8"×35.1" 在范围内 |
| C4 | 14 日 ~14:00 前拆除 | ⏳ | 遗留物将被移除 |
| C5 | 保留海报备后续使用 | ℹ️ | — |

### D. 海报展示（2026-08-14 Fri 9:30–12:00，ERBLT foyer 8/F ERB）

| # | 条目 | 状态 | 备注 |
|---|------|------|------|
| D1 | 强制出席，9:20 前到场签到 | ⏳ | 08-14 |
| D2 | 10–15 分钟展示 + Q&A（2 名 examiner） | ⏳ | 准备讲稿 |
| D3 | 仅 examiner / 参与者 / TA 可入内 | ℹ️ | — |
