...
nearest-neighbor baseline. End-to-end on 200 real screenshots with a Qwen3-VL
...
is already accurate. This is the expected ``Goldilocks'' behavior: the
...
achieves 90--94\% violation accuracy, a $+56\%$ IoU gain over nearest-neighbor
