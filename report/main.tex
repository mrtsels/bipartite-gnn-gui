...
% Margins: 1in = 2.54cm, reduced by 0.5cm on all sides -> 2.04cm
\usepackage[margin=2.04cm]{geometry}
\usepackage{setspace}
\onehalfspacing
...
\begin{tikzpicture}[scale=1.0, transform shape]
  ...
  \node[anchor=east, font=\footnotesize] at (\base-0.1,4.175) {Remove \texttt{CONTAINMENT}};
  ...
  \node[anchor=east, font=\footnotesize] at (\base-0.1,2.175) {Remove \texttt{GRID}};
  ...
  \node[anchor=east, font=\footnotesize] at (\base-0.1,1.175) {Remove all \texttt{ALIGNMENT}};
