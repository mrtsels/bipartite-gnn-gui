...
\vspace{2pt}
{\rule{0.55\textwidth}{1.6pt}\par}
\vfill

% --- Program label with flanking rules ---
\begin{minipage}{0.92\textwidth}
\centering
{\normalsize\textbf{Summer Research Project}\par}
\vspace{0.9cm}
...
Xie Licheng (Alex) & Prof.\ Wing Cheong Lau (IE) \\
1155246441 & Department of Information Engineering \\
\end{tabular}
\vspace{1.4cm}

% --- Date, closed by a rule ---
{\color{black!55}\rule{0.3\textwidth}{0.5pt}\par}
\vspace{0.35cm}
