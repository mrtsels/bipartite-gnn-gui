...
\usepackage{setspace}
\onehalfspacing
% Author-year citations: [Xie et al., 2024] style
\usepackage[square,comma,authoryear]{natbib}
\setcitestyle{square,comma,authoryear}
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyfoot[C]{\thepage}
...
\begin{tikzpicture}[scale=1.0, transform shape]
  ...
  \begin{scope}[shift={(0,0)}]
    ...
    \node[font=\scriptsize] at (1.1,{0.876*\sc+0.15}) {0.876};
    % violation-only
    \fill[blue!60] (2.0,0) rectangle (3.0,{0.898*\sc});
    \node[font=\scriptsize] at (2.5,{0.898*\sc+0.15}) {0.898};
    % proposal-only
    \fill[blue!60] (3.4,0) rectangle (4.4,{0.489*\sc});
    \node[font=\scriptsize] at (3.9,{0.489*\sc+0.15}) {0.489};
    ...
    \node[font=\scriptsize] at (1.1,-0.5) {joint};
    \node[font=\scriptsize] at (2.5,-0.5) {violation-only};
    \node[font=\scriptsize] at (3.9,-0.5) {proposal-only};
  \end{scope}
  ...
  \begin{scope}[shift={(6.6,0)}]
    ...
    \node[font=\scriptsize] at (1.1,{0.051*\scm+0.15}) {0.051};
    \fill[blue!60] (2.0,0) rectangle (3.0,{0.116*\scm});
    \node[font=\scriptsize] at (2.5,{0.116*\scm+0.15}) {0.116};
    \fill[blue!60] (3.4,0) rectangle (4.4,{0.051*\scm});
    \node[font=\scriptsize] at (3.9,{0.051*\scm+0.15}) {0.051};
    % error bars (std: 0.009, 0.009, 0.010) *30
