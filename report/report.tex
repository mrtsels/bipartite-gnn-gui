...
Fig.~\ref{fig:motivating} shows the two failure modes on a real screenshot.
...
track constraint counts almost linearly (Fig.~\ref{fig:vcount}, $r = 0.96$):
...
Fig.~\ref{fig:constraints} quantifies the graph sizes behind
Table~\ref{tab:ablation}: removing all alignment types leaves 15.1
